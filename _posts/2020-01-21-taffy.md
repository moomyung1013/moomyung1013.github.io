...
# 실행 화면   
1. 기본화면   
<!--![basicScreen](https://github.com/moomyung1013/Level2_Taffy/blob/master/img/basicScreen.png)-->
<img src="https://github.com/moomyung1013/Level2_Taffy/blob/master/img/basicScreen.png" width="40%" height="30%" title="px(픽셀) 크기 설정" alt="RubberDuck"></img>
1. 창구 수 선택
1. 한 개의 창구
1. 두 개의 창구
1. 세 개의 창구
